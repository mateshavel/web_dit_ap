$(function () {
    ...
    /** Init Category-story carousel **/
    if (contentWrapper.hasClass('category-story-wrapper')) {
        var carousel = $('#ditap-carousel-story');
        initCarouselStory(carousel[0]);
    }

    /** Init Category-story carousel **/
    if (contentWrapper.hasClass('category-story-wrapper')) {
        var carousel = $('#ditap-carousel-story-2');
        initCarouselStory2(carousel[0]);
    }

    /** Init Category-story carousel **/
    if (contentWrapper.hasClass('category-story-wrapper')) {
        var carousel = $('#ditap-carousel-story-3');
        initCarouselStory3(carousel[0]);
    }

    /** Init Category-story carousel **/
    if (contentWrapper.hasClass('category-story-wrapper')) {
        var carousel = $('#ditap-carousel-story-4');
        initCarouselStory4(carousel[0]);
    }
    ...
    function initCarousel(carousel) {
        ...
        var pauseLi = $('#ditap-carousel li');
        var pauseBtn = $('#ditap-carousel .btn-ditap');
        var pauseCards = $('#ditap-carousel .teaser-cards-promo');
    ...
    function initCarouselStory(carousel) {
        ...
        var percent = 0;
        var bar = $('.transition-timer-carousel-progress-bar');
        var crsl = $('#ditap-carousel-story');
        var pauseLi = $('#ditap-carousel-story li');
        var pauseBtn = $('#ditap-carousel-story .btn-ditap');
        var pauseCards = $('#ditap-carousel-story .teaser-cards-promo');
    ...
    function initCarouselStory2(carousel) {
    ...
    function initCarouselStory3(carousel) {
    ...
    function initCarouselStory4(carousel) {
